...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.list-workplan" action="/anonymous/work-plan/list"/>
		</acme:menu-option>

		<acme:menu-option code="master.menu.administrator" access="hasRole('Administrator')">
		    <acme:menu-suboption code="master.menu.administrator.spam.word.list" action="/administrator/word-class/list"/>
		    <acme:menu-suboption code="master.menu.administrator.spam.word.add" action="/administrator/word-class/create"/>
		    <acme:menu-separator/>
