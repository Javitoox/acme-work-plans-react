...
<%
	if(request.getAttribute("javax.servlet.forward.request_uri").toString().equals("/anonymous/shout/list_recent") 
		|| request.getAttribute("javax.servlet.forward.request_uri").toString().equals("/Acme-Work-Plans/anonymous/shout/list_recent")){
%>
	<acme:form>
